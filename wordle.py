...
for i in range(6):
  ...
  if hint == "GGGGG":
    print ("You win!")
    break
# TASK N: After the loop has finished, meaning the user has run out of guesses, check if hint != "GGGGG". If so, the user has lost. Print a lose message.# TASK A: Define a variable 'word' that holds the correct word for the wordle game
if hint != "GGGGG":
  print("You lose, sad, The world was ", word)